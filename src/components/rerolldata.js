		...
		hero_details: [
			{
				...
				reason1: "Unique skill in the game that is able to reset the cooldown of any ally's skill while also granting herself an extra turn.",
				reason2: "Her Full Bloom dispels all buffs then applies a 2 turn Defense Break and Unbuffable debuff. While Unbuffable might not be as useful in PVE, it is quite an effective debuff for pvp. Defense Break is universally good in every situation barred bosses that have mechanics that makes debuffing them dangerous."
			}
		]
	},
	{
